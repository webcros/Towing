 ...
 * theme → pressable primitive → font gate. Order matters — theme must wrap
 * everything that reads it (MotionPressable included), and the font gate holds
 * the first paint until Inter is loaded.
 */
        ...
        <QueryProvider>
          <ThemeProvider preference={preference}>
            {/* Swaps the Pressable inside every @towing/ui component for the
                Reanimated-backed one. The driver app mounts no provider and
                keeps the plain RN Pressable, so it needs no animation deps. */}
